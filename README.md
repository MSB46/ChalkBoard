...
### Enroll
This is the enroll.html page for the ChalkBoard website. This is where the user is supposed to view the information about the available courses. There is also a searchbar to filter specific classes the user may be interested in. Additionally, the user would be given the option to enroll in the class. All data is placeholder values for the time being. Includes a navigation bar and breadcrumbs for convenience.

_FooTable, a jQuery plugin is used to help create the vertical layout tables on mobile._

![enroll-html](https://user-images.githubusercontent.com/33902649/142570683-37747112-f1cb-4928-845e-6e1d02389e06.png)
![ipad-enroll-html](https://user-images.githubusercontent.com/33902649/142571086-3c44022e-8fdb-4030-b5c6-51457cc7dd9f.png)
...
## Admin Features
### Admin login
This is the login.html page for the ChalkBoard website. At the moment, it includes a two form input elements for username and password. Unlike the instructor and student login pages however, there is no register page (for obvious reasons). Clicking on the logo leads to index.html

![admin-login-html](https://user-images.githubusercontent.com/33902649/142573703-40a5bbdf-60a3-4f3f-bd52-cbad78778f66.png)



### Admin-view
This is the admin-view.html page for the ChalkBoard website. The goal for this page is to preview the all available courses. There is also a search bar which is supposed to be used to filter specific courses. All data is placeholder values for the time being. Includes a navigation bar and breadcrumbs for convenience. The tables are responsive such that not all columns of a particular row will appear unless toggled.

_FooTable, a jQuery plugin is used to help create the vertical layout tables on mobile._

![admin-view-html-desktop](https://user-images.githubusercontent.com/33902649/142572546-4006fc5c-383e-458f-bb1a-8e7dbac1b06b.png)
![admin-view-html-mobile](https://user-images.githubusercontent.com/33902649/142572632-86ff4edf-c149-4fdc-9fa5-3efca0cd1044.png)

### View Course-data
This is the course-data.html page for the ChalkBoard website. Clicking on the name of a course as an admin is supposed to lead to this page. Here, it would show various information regarding the clicked course like the instructor and the list of students enrolled (and their grades if available). All data is placeholder values for the time being. Includes a navigation bar and breadcrumbs for convenience.

_FooTable, a jQuery plugin is used to help create the vertical layout tables on mobile._

![course-data-html-desktop](https://user-images.githubusercontent.com/33902649/142572854-e08ce222-6b5e-44b5-b3bb-7ee2fc8874e9.png)
![course-data-html-mobile](https://user-images.githubusercontent.com/33902649/142573144-c0b5dc50-5d1f-400f-a15d-9f44dd12f0f1.png)

### View instructor-data
This is the instructor-data.html page for the ChalkBoard website. Clicking on the name of an instructor is supposed to lead to this page. Here, it would show various information regarding the clicked instructor like the courses they're teaching, email, ID, etc. (not all info values are final). All data is placeholder values for the time being. Includes a navigation bar and breadcrumbs for convenience.

_FooTable, a jQuery plugin is used to help create the vertical layout tables on mobile._

![instructor-data-html-desktop](https://user-images.githubusercontent.com/33902649/142573268-51d6fe30-9b12-4dc8-a91b-5ec618693a1e.png)
![instructor-data-html-mobile](https://user-images.githubusercontent.com/33902649/142573348-7c87d3c7-db22-4ead-8e1b-c6e1087b33d4.png)

### View student-data
This is the student-data.html page for the ChalkBoard website. Clicking on the name of a student as an admin is supposed to lead to this page. Here, it would show various information regarding the clicked student like the courses they're in, email, ID, etc. (not all info values are final). All data is placeholder values for the time being. Includes a navigation bar and breadcrumbs for convenience.

_FooTable, a jQuery plugin is used to help create the vertical layout tables on mobile._

![student-data-html-desktop](https://user-images.githubusercontent.com/33902649/142573468-a4cd8ea0-6992-44ae-812f-c046a74a215b.png)
![student-data-html-mobile](https://user-images.githubusercontent.com/33902649/142573534-02773eeb-f947-4a44-b4ac-5d87c4482eb9.png)
